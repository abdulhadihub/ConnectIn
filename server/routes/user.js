...
import {
    ...
    changeInterests, changeAbout, suggestUsers, getUserByUserName, unfollowUser, searchUsers
...
router.put("/block/:userId", verifyUser, blockUser);
router.put("/unblock/:userId", verifyUser, unblockUser);
