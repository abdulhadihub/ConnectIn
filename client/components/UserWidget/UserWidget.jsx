            ...
            <Link href={`/profile`}>
                <div className='flex justify-center md:justify-center'>
                    <div className='w-full md:w-[110px]   p-4 flex md:flex-col justify-center items-center'>
                        {!user?.profileImage ? (
                            <img src='/user.jpg' width={100} height={100} className='object-cover rounded-full' />
                        ) : (<img src={`${server}/images/${user?.profileImage}`} width={100} height={100} className='object-cover rounded-full' />)}
